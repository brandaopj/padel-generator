...
export const translations = {
  pt: {
    ...
    generator: {
      ...
      maxRoundsOf: (total: number) => `de ${total} possíveis`,
      allRounds: 'Todas',
      leaveGuardTitle: 'Sair sem gerar?',
    ...
    history: {
      ...
      filterAll: 'Todos',
      noResults: 'Nenhum torneio encontrado com os filtros actuais.',
      empty: {
  ...
  en: {
    ...
    generator: {
      ...
      maxRoundsOf: (total: number) => `of ${total} possible`,
      allRounds: 'All',
      leaveGuardTitle: 'Leave without generating?',
    ...
    history: {
      ...
      filterAll: 'All modes',
      noResults: 'No tournaments match the current filters.',
      empty: {
